...
cat pt/pt.txt | sed -r 's/(.*)/\L\1/g ; s/[<>]//g ; s/^(.*)$/<<\1>/g ; s/([^ ])([().:,;/%-+"“”])/\1 \2/g ; s/([().:,;/%-+"“”])([^ ])/\1 \2/g ; s/([().:,;/%-+"“”]) ([>])$/\1\2/g' > pt/ptNOR.txt;
cat en/en.txt | sed -r 's/(.*)/\L\1/g ; s/[<>]//g ; s/^(.*)$/<<\1>/g ; s/([^ ])([().:,;/%-+"“”])/\1 \2/g ; s/([().:,;/%-+"“”])([^ ])/\1 \2/g ; s/([().:,;/%-+"“”]) ([>])$/\1\2/g' > en/enNOR.txt;
cat fr/fr.txt | sed -r 's/(.*)/\L\1/g ; s/[<>]//g ; s/^(.*)$/<<\1>/g ; s/([^ ])([().:,;/%-+"“”])/\1 \2/g ; s/([().:,;/%-+"“”])([^ ])/\1 \2/g ; s/([().:,;/%-+"“”]) ([>])$/\1\2/g' > fr/frNOR.txt;
cat de/de.txt | sed -r 's/(.*)/\L\1/g ; s/[<>]//g ; s/^(.*)$/<<\1>/g ; s/([^ ])([().:,;/%-+"“”])/\1 \2/g ; s/([().:,;/%-+"“”])([^ ])/\1 \2/g ; s/([().:,;/%-+"“”]) ([>])$/\1\2/g' > de/deNOR.txt;
cat it/it.txt | sed -r 's/(.*)/\L\1/g ; s/[<>]//g ; s/^(.*)$/<<\1>/g ; s/([^ ])([().:,;/%-+"“”])/\1 \2/g ; s/([().:,;/%-+"“”])([^ ])/\1 \2/g ; s/([().:,;/%-+"“”]) ([>])$/\1\2/g' > it/itNOR.txt;
